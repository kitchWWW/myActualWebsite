...
data = [
	...
	['/CyanotypeScoreCards','Cyanotype Score Cards','graphic score collection', 2025, True, ["perform","listen"]],
	['/AfterClosenessLines','After Closeness Lines','Open Instrumentation Duets', 2025, True, ["perform", "listen"]],
	...
	['/memoryFieldJournals','Memory Field Journals','cumulative field recordings', 2024, True, ["listen","perform"]],
	['/drawjam','Draw Jam','participatory graphic scores', 2024, True, ["listen","perform"]],
	['/differentListening','Different Listening','guided listening experience', 2024, True, ["listen","perform"]],
